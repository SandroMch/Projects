...
public class FacePamphletProfile implements FacePamphletConstants {
	...
	private GImage newProfileImage;
	private ArrayList<String> friends;

	public FacePamphletProfile(String name) {			//creates new profile
		newProfile = name;
	 ...
	 */
	public GImage getImage() {					//returns image
		return newProfileImage;
	}

	/** This method sets the image associated with the profile. */
	public void setImage(GImage image) {				//initializing image created by me
	...
	public void setStatus(String status) {			//sets status
		currStatus = status;
	}
	 ...
	 */
	public boolean addFriend(String friend) {			//if friend exists adds in arrayList
	 ...
	 */
	public boolean removeFriend(String friend) {		//removes friend from arrayList
			if(friends.contains(friend)) {
	 ...
	 * the profile.
	 */
	public Iterator<String> getFriends() {						//returns strings from freinds arrayList
		Iterator<String> getFriendsIterator = friends.iterator();		
		return getFriendsIterator;
	}
	...
	public String toString() {
			String showProfile = newProfile + " (" + currStatus + ") : ";
			Iterator<String> getFriendsIterator = getFriends();
			if(getFriendsIterator.hasNext()) {
				showProfile += getFriendsIterator.next();
			}while(getFriendsIterator.hasNext()) {
				showProfile = showProfile + (", " + getFriendsIterator.next());
			}
